...
If a directory contains audio files but no manifest file, the script will generate a blank .CSV manifest listing:
samplename, duration, datetime recorded, samplesize, samplerate, channels, and spaces for a description and location recorded (to be filled out manually later)
...
manifest_csv.erb
manifest_index_html.erb

Used by create_manifest.rb
USAGE:
